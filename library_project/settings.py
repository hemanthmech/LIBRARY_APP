...
# Load environment variables from .env file (not committed to version control)
load_dotenv()

BASE_DIR = Path(__file__).resolve().parent.parent

# SECURITY: Secret key loaded from environment variable, never hardcoded
SECRET_KEY = os.environ.get("SECRET_KEY")

# SECURITY: Debug mode controlled by environment variable - FALSE in production
